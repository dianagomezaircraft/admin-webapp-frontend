// components/modals/EditContentModal.tsx
'use client';
...
import { contentService, Content, ContentType, UpdateContentData } from '@/lib/content';
...
export default function EditContentModal({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await contentService.update(content.id, updateData);
      onSuccess();
    } catch (err) {
