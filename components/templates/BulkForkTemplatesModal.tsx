...
export function BulkForkTemplatesModal({
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="w-full max-w-2xl flex flex-col" style={{ maxHeight: 'calc(100vh - 2rem)' }}>
                                        ...
                                        filtered.map((template) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    disabled={isSubmitting}
                                                    className={`w-full text-left flex items-center space-x-3 p-3 rounded-lg border transition-all ${isSelected
                        ...
                        {isDone && results && (
                            <div className="overflow-y-auto px-6 py-4 space-y-2" style={{ maxHeight: '400px' }}>
                                ...
                                {results.map((r) => (
                                    <div
                                        key={r.template.id}
                                        className={`flex items-center space-x-3 p-3 rounded-lg border ${r.status === 'success'
